...
class WebsocketClient
{
	...
	public function connect($header_ext, $host, $port, $path, $origin = false)
	{
		$this->_host = $host;
		$this->_port = $port;
		$this->_path = $path;
		...
		$header.= "\r\n";// This is HTTP requirement: "Response ends with /r/n/r/n"
	
		//echo "<br><b>header:</b><br>".$header."\r\n";		
		
		$this->_Socket = stream_socket_client("tcp://".$host.":".$port, $errno, $errstr, 30);
		...
		if($response===FALSE){
			//echo "<br><b>response===FALSE </b><br>";
			//echo "<br><b>errno:".socket_last_error($this->_Socket)."</b><br>";
			//echo "<br><b>errstr:".socket_strerror(socket_last_error($this->_Socket))."</b><br>";
		}
		
		//echo "<br><b>response:</b><br>".$response;
		...
		if ($matches) {
			...
			//echo "<br><b>matches:</b><br>".$matches[1];
			//echo "<br><b>keyAccept:</b><br>".$keyAccept;
			//echo "<br><b>expectedResonse:</b><br>".$expectedResonse;
	...
	public function _hybi10Encode($payload, $type = 'text', $masked = true)
	{
		$frameHead = array();
		$frame = '';
	...
	public function _hybi10Decode($data)
	{
		$payloadLength = '';
		$mask = '';
		$unmaskedPayload = '';
