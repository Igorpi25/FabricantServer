...
<div class="container">
	<div class="page-header">
		<h4><a href="http://igorserver.ru/v2/admin/customers.php">Заказчики</a></h4>
	</div>
	<div class="row">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Заказчики</h4>
			</div>
...
<div class="modal fade" id="contractorUsersModal" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Пользователи заказчика</h4>
			</div>
			<div class="modal-body">
...
<div class="modal fade" id="contractorDetailsModal" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Детали заказчика</h4>
			</div>
			<div class="modal-body">
...
function getContractors() {
	$.ajax({
		method: "GET",
		url: "http://igorserver.ru/v2/admin/customers",
		cache: false,
		dataType: "json",
		success: function(response) {
			if (response["error"] == false)
...
function updateContractor(id, name, address, phone, status, info) {
	$.ajax({
		method: "PUT",
		url: "http://igorserver.ru/v2/admin/customers/" + id,
